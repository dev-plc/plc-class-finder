...
- 📊 전체 출석표 — 조 전체를 주차 × 사람 표로. 이름 옆에 진행률(`12/16`)
- **우리 조 N명 · 수료 N · 예정 N · 챙길 사람 N** — 누르면 챙길 사람과 할 일만 펼쳐진다
...
| **수료 현황** | 수료 · 수료 예정 · 아슬아슬 · 수료 불가 · 관리자 확인 · 명단 복사 |
| **출석부 출력** | 조별 A4 인쇄 |

위쪽 **⟳ 시트에서 지금 가져오기** 는 일 1회 동기화를 지금 돌린다
(GAS → GitHub Actions).

오른쪽 위 배지에 **지금 도는 버전**이 뜬다 (`3기 · 관리자 · v103`).
고친 게 안 보이면 여기부터 본다.
