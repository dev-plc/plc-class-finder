...
import { sbSelect, sbSelectAll, sbPostGas, getActiveCohortId, getCachedCohortId } from './supabase-config.js?v=41';

export const MODULE_VERSION = 'members-data v41 (조원 명단 출결 복구)';
