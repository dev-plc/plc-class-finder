...
import { sbSelect, sbSelectAll, sbPostGas, getActiveCohortId, getCachedCohortId } from './supabase-config.js?v=44';

export const MODULE_VERSION = 'members-data v44 (검색칸 지우기)';
