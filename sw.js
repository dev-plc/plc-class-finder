...
const PRECACHE_URLS = [
  ...
  './script.js?v=109',
  './admin.js?v=109',
  './scripts/members-data.js?v=109',
  './scripts/supabase-config.js?v=109',
  './scripts/hangul.js?v=109',
  './scripts/sw-update.js?v=109',
  './scripts/attendance-matrix.js?v=109',
