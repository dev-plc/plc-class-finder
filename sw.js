...
const PRECACHE_URLS = [
  ...
  './script.js?v=110',
  './admin.js?v=110',
  './scripts/members-data.js?v=110',
  './scripts/supabase-config.js?v=110',
  './scripts/hangul.js?v=110',
  './scripts/sw-update.js?v=110',
  './scripts/attendance-matrix.js?v=110',
