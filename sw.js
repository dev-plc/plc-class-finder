...
const PRECACHE_URLS = [
  ...
  './script.js?v=107',
  './admin.js?v=107',
  './scripts/members-data.js?v=107',
  './scripts/supabase-config.js?v=107',
  './scripts/hangul.js?v=107',
  './scripts/sw-update.js?v=107',
  './scripts/attendance-matrix.js?v=107',
